...
echo "<div style='margin:5px; margin-top:0px; margin-left:15px;'><div style='width:20px; height:20px; margin:2px; border:1px solid black; background: green'></div> - Available seats</div>";
